...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE dad SET user_name='$user_name', email='$email', gender='$gender', age='$age', telephone='$telephone', country='$country' WHERE user_id='$user_id'";
...
$user_id = $_SESSION['user_id'];
$query = "SELECT * FROM dad WHERE user_id='$user_id'";
